package com.geek.libshadowlayout.widgets;
...
import com.geek.libshadowlayout.R;
...
public class ShadowLayouts extends FrameLayout {
    ...
    public ShadowLayouts(Context context) {
        this(context, null);
    }

    public ShadowLayouts(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public ShadowLayouts(Context context, AttributeSet attrs, int defStyleAttr) {
